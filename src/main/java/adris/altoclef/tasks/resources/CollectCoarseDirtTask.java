...
public class CollectCoarseDirtTask extends ResourceTask {
    ...
    protected Task onResourceTick(AltoClef mod) {
        double c = Math.ceil(Double.valueOf(_count-mod.getItemStorage().getItemCount(Items.COARSE_DIRT)) / 4) * 2; // Minimum number of dirt / gravel needed to complete the recipe, accounting for coarse dirt already collected.
