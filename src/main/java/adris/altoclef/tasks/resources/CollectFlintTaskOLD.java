 ...
 */
@Deprecated
public class CollectFlintTaskOLD extends ResourceTask {
    ...
    public CollectFlintTaskOLD(int targetCount) {
    ...
    protected Task onResourceTick(AltoClef mod) {
        ...
        _closest = mod.getBlockTracker().getNearestTracking(mod.getPlayer().getPos(), Blocks.GRAVEL);
        /*
    ...
    protected boolean isEqualResource(ResourceTask obj) {
        if (obj instanceof CollectFlintTaskOLD) {
            CollectFlintTaskOLD task = (CollectFlintTaskOLD) obj;
