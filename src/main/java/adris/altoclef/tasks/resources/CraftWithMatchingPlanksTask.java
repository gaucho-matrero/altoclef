...
public class CraftWithMatchingPlanksTask extends CraftWithMatchingMaterialsTask {
    ...
    protected int getExpectedTotalCountOfSameItem(AltoClef mod, Item sameItem) {
        // Include logs
        return mod.getInventoryTracker().getItemCountIncludingTable(sameItem) + mod.getInventoryTracker().getItemCountIncludingTable(ItemHelper.planksToLog(sameItem)) * 4;
    }
