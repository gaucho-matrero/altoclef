...
public class ConstructNetherPortalBucketTask extends Task {
    ...
    private static final Vec3i[] PORTAL_FRAME = new Vec3i[]{
            // Left side
            new Vec3i(0, 0, -1), new Vec3i(0, 1, -1), new Vec3i(0, 2, -1),
            // Right side
            new Vec3i(0, 0, 2), new Vec3i(0, 1, 2), new Vec3i(0, 2, 2),
            // Bottom
            new Vec3i(0, -1, 0), new Vec3i(0, -1, 1),
            // Top
            new Vec3i(0, 3, 0), new Vec3i(0, 3, 1)
    };
    ...
    private static final Vec3i[] CAST_FRAME = new Vec3i[]{
            new Vec3i(0, -1, 0), new Vec3i(0, 0, -1), new Vec3i(0, 0, 1), new Vec3i(-1, 0, 0), new Vec3i(1, 0, 0), new Vec3i(1, 1, 0)
    };
    ...
    protected Task onTick(AltoClef mod) {
        ...
        for (Vec3i framePosRelative : PORTAL_FRAME) {
            ...
            if (frameBlock != Blocks.LAVA) {
                ...
                return new InteractItemWithBlockTask(new ItemTarget("lava_bucket", 1), Direction.WEST, _currentLavaTarget.add(1, 0, 0),
                                                     false);
            }
            ...
            if (mod.getWorld().getBlockState(waterCheck).getBlock() != Blocks.WATER) {
                ...
                return new InteractItemWithBlockTask(new ItemTarget("water_bucket", 1), Direction.WEST, _currentLavaTarget.add(1, 1, 0),
                                                     true);
            }
        }
