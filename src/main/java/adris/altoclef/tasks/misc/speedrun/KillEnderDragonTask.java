...
public class KillEnderDragonTask extends Task {
    ...
    private final Task _collectBuildMaterialsTask = new MineAndCollectTask(new ItemTarget(Items.END_STONE, 100),
    ...
    protected void onStart(AltoClef mod) {
        ...
        mod.getConfigState().addForceFieldExclusion(
    ...
    protected Task onTick(AltoClef mod) {
        ...
        if (mod.getEntityTracker().entityFound(EndCrystalEntity.class) && mod.getInventoryTracker().getItemCount(Items.DIRT,
                                                                                                                 Items.COBBLESTONE,
                                                                                                                 Items.NETHERRACK,
                                                                                                                 Items.END_STONE) <
                                                                          MINIMUM_BUILDING_BLOCKS ||
        ...
        if (mod.getEntityTracker().entityFound(EndCrystalEntity.class)) {
            ...
            return new DoToClosestEntityTask(() -> mod.getPlayer().getPos(), (toDestroy) -> {
    ...
    private class PunkEnderDragonTask extends Task {
                ...
                case RAILING:
                    ...
                    if (head.isInRange(mod.getPlayer(), 7.5) && dragon.ticksSinceDeath <= 1) {
                        ...
                        Rotation targetRotation = RotationUtils.calcRotationFromVec3d(
                                mod.getClientBaritone().getPlayerContext().playerHead(), targetLookPos,
        ...
        private BlockPos getRandomWanderPos(AltoClef mod) {
            ...
            while (pos == null) {
                ...
                int x = (int) (radius * Math.cos(angle)), z = (int) (radius * Math.sin(angle));
